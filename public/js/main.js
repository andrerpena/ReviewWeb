...
/***/ function(module, exports, __webpack_require__) {
	...
	Router.run(routes, Router.HistoryLocation, function (Root, state) {
		...
		React.render(React.createElement(Handler, { query: state, path: state.pathname }), document.getElementById('app'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Views = {};
	Views.Test = __webpack_require__(198);
	
	var routes = React.createElement(
		Route,
		null,
		React.createElement(Route, { name: 'test', path: '/testpage', handler: Views.Test })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(9);
	var canUseDOM = __webpack_require__(53).canUseDOM;
